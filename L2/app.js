...
// console.log(person)
//Types in variable
var favouriteLanguage1; //means string ka array hii sirf iss variable mein jaa saktta hai
favouriteLanguage1 = ["Hindi", "English"];
var favouriteLanguage2; //any means iss array mein koi bhi type de sakte hai so its loose the powerfull of Typescript
...
; //so enum tab use karte hai jab data ko dynamically dikhana hoo
var person3 = {
    name: "aman",
    age: 21,
    skills: ["React", "Node"],
